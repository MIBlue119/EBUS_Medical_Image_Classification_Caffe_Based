...
CSV_FILE=root+'caffe_models/caffe_model_2/cross_'+model_number_s+'.csv'
SVM_FILE=root+'caffe_models/caffe_model_2/svm_'+model_number_s+'.csv'
RF_FILE=root+'caffe_models/caffe_model_2/rf_'+model_number_s+'.csv'
GBC_FILE=root+'caffe_models/caffe_model_2/gbc_'+model_number_s+'.csv'
caffe.set_mode_gpu() 
